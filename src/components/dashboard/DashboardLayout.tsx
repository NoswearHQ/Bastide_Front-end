...
import { FileText, Package, FolderTree, LogOut, Home, BarChart3, ArrowUpDown, FileCode } from "lucide-react"; // ✅ ajout de FolderTree
    ...
    <div className="min-h-screen flex bg-gray-100">
      ...
      <aside className="w-64 bg-white shadow-md">
        ...
        <nav className="mt-6 flex flex-col space-y-1">
          ...
          {/* ✅ Lien pour les produits de la page d'accueil */}
          <NavLink
            to="/dashboard/homepage-products"
            className={({ isActive }) =>
              `px-6 py-3 flex items-center space-x-2 hover:bg-gray-100 ${
                isActive ? "bg-gray-200 font-semibold" : ""
              }`
          ...
          {/* ✅ Lien pour l'ordre des produits par catégorie */}
          <NavLink
            to="/dashboard/category-products-order"
            className={({ isActive }) =>
              `px-6 py-3 flex items-center space-x-2 hover:bg-gray-100 ${
                isActive ? "bg-gray-200 font-semibold" : ""
              }`
